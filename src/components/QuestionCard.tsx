          ...
          <div className="mt-1 grid grid-cols-2 gap-2 sm:grid-cols-3">
            {question.options.map((opt) => (
              <button
                ...
                className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-center text-base font-medium hover:border-blue-500 hover:bg-blue-50 transition-colors ltr-numbers"
              >
                {opt}
              </button>
            ))}
